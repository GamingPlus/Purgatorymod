...
public class OverWorldTeleportProcedure extends InbetweendimensionModElements.ModElement {
	public OverWorldTeleportProcedure(InbetweendimensionModElements instance) {
		super(instance, 35);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure OverWorldTeleport!");
			return;
		}
