...
public class NetherWorldTeleportProcedure extends InbetweendimensionModElements.ModElement {
	public NetherWorldTeleportProcedure(InbetweendimensionModElements instance) {
		super(instance, 36);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure NetherWorldTeleport!");
			return;
		}
