...
public class SoulCoreOreBlock extends InbetweendimensionModElements.ModElement {
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("soul_core_ore", "soul_core_ore", blockAt -> {
			...
			}), block.getDefaultState(), 9), Placement.COUNT_RANGE, new CountRangeConfig(20, 5, 5, 40)));
		}
	}
}
