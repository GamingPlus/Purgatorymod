...
public class SoulCapsuleItem extends InbetweendimensionModElements.ModElement {
	@ObjectHolder("inbetweendimension:soul_capsule")
	public static final Item block = null;
	@ObjectHolder("inbetweendimension:entitybulletsoul_capsule")
	public static final EntityType arrow = null;
	public SoulCapsuleItem(InbetweendimensionModElements instance) {
		super(instance, 55);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletsoul_capsule").setRegistryName("entitybulletsoul_capsule"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(SoulCapturerItem.block, (int) (1));
		}
