...
public class PurgatoryDivineBowItem extends InbetweendimensionModElements.ModElement {
	@ObjectHolder("inbetweendimension:purgatory_divine_bow")
	public static final Item block = null;
	@ObjectHolder("inbetweendimension:entitybulletpurgatory_divine_bow")
	public static final EntityType arrow = null;
	public PurgatoryDivineBowItem(InbetweendimensionModElements instance) {
		super(instance, 72);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletpurgatory_divine_bow").setRegistryName("entitybulletpurgatory_divine_bow"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("purgatory_divine_bow");
		}
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
					...
					if (stack != null && stack.getItem() == new ItemStack(PurgatoryArrowItem.block, (int) (1)).getItem()) {
						slotID = i;
						break;
					}
				}
				if (entity.abilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0 || slotID != -1) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 10f, 5.1, 6);
					itemstack.damageItem(1, entity, e -> e.sendBreakAnimation(entity.getActiveHand()));
					if (entity.abilities.isCreativeMode) {
						entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.CREATIVE_ONLY;
					} else {
						ItemStack stack = entity.inventory.getStackInSlot(slotID);
						if (new ItemStack(PurgatoryArrowItem.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(PurgatoryArrowItem.block, (int) (1));
		}
